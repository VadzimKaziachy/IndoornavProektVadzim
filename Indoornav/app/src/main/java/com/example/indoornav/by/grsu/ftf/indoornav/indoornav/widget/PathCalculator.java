package com.example.indoornav.by.grsu.ftf.indoornav.indoornav.widget;

/**
 * Created by Вадим on 25.07.2017.
 *
 * сюда будет приходить карта с класс MainActivity по которой будет строиться путь из точки A в точку Б. Координаты точки А будут
