package com.example.indoornav.by.grsu.ftf.indoornav.navigation.map;
 ...
 * //этот класс будет отвечать за карты, а именно, после определения местоположеня человека, класс MainActivity будет отправлять
 ...
 //будет отправляться в класс PathCalculator куда тоже будут отправляться координаты местоположения человека.
